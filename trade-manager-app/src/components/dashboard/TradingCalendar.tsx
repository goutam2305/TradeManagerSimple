...
export const TradingCalendar: React.FC<TradingCalendarProps> = ({ data }) => {
    ...
    return (
        <div className="glass-panel p-6 h-full flex flex-col relative overflow-hidden group">
            <div className="absolute -top-10 -right-10 w-48 h-48 bg-accent/5 rounded-full blur-[80px] group-hover:bg-accent/10 transition-colors pointer-events-none" />
                    ...
                    {days.map(day => {
                        ...
                        return (
                            <div
                                ...
                                flex flex-col items-center justify-center relative group cursor-default transition-all hover:scale-105 hover:z-50
                            `}
                            >
